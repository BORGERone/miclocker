...
<p align="center">
  ...
  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Flag_of_Japan.svg/1200px-Flag_of_Japan.svg.png" alt="Japanese" width="30"/> <b>日本語</b> &nbsp;&nbsp;
...
<p align="center">
  <img src="hero.png" alt="MicLocker バナー" width="880">
</p>
...
MicLockerはWindows用の軽量デスクトップアプリケーションで、特定のオーディオデバイスをマイクとして選択し、音量レベルを設定できます。アプリケーションは継続的なループで選択された音量レベルを自動的に監視・維持します。
...
- **Windows API**: Core Audio APIアクセス用 `windows` クレート

## 要件

- Windows 10/11
- Node.js 18以上
- Rustツールチェーン（ソースからのビルド用）
