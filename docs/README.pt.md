...
<p align="center">
  ...
  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Flag_of_Brazil.svg/1200px-Flag_of_Brazil.svg.png" alt="Portuguese" width="30"/> <b>Português</b> &nbsp;&nbsp;
...
MicLocker é um aplicativo de desktop leve para Windows que permite selecionar um dispositivo de áudio específico como microfone e definir seu nível de volume. O aplicativo monitora e mantém automaticamente o nível de volume escolhido em um loop contínuo.
...
- Selecionar microfone entre os dispositivos de entrada de áudio disponíveis
- Definir nível de volume (0–100%)
...
Após a compilação, você encontrará os executáveis em:
...
- **API do Windows**: Crate `windows` para acesso à Core Audio API
